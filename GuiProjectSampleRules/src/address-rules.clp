;(bind ?dir (call System getProperty "user.dir") )
;(bind ?templates (str-cat ?dir "\\actual_rules\\deftemplates.clp"))
;(printout t ?templates crlf)
;(batch ?templates)
;(provide loc-of-deftemplates)
;(require loc-of-deftemplates ?templates) 
;(require  loc-of-deftemplates "/actual_rules/deftemplates.clp"); 

(defclass address-template gui.AddressBean)
