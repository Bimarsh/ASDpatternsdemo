...
class CustomTableModel extends AbstractTableModel {
    ...
    /** Assumes that the elements of the List are of type Object[]. 
     *  If not, none of the elements in the List are added to the model.
     * 
     */
    public void setTableValues(java.util.List vals) {
    	if(vals == null) {
    		return;
    	}
