...
public class DefaultData {
    ...
    public String[][] getCartItemsData() {
    	return cartItemsData;
    }
    @SuppressWarnings("unchecked")
	public java.util.List getCartItemsList() {
    	Object[] firstRow = {GARDEN_OF_RAMA,
    			new Integer(2),
				GuiControl.formatDouble(new Double(50.00)),
				GuiControl.formatDouble(new Double(100.00))};
    	cartItemsList = new ArrayList();
    	cartItemsList.add(firstRow); 	
	...
	private static HashMap catalogWindowData = new HashMap();
	

	public String[][] getCatalogWindowData(String catalog) {
		return (String[][])catalogWindowData.get(catalog);
	}
	...
	private static HashMap productDetailsData = new HashMap();
	...
	public HashMap getProductDetailsData() {
	...
	public String[][] getSelectOrderDefaultData() {
		return selectOrderDefaultData;
	}
	...
	public String[][] getViewOrderDetailsDefaultData() {
		return viewOrderDetailsDefaultData;
	}
	...
	private static HashMap productCatalogChoices;
	
	static {
		productCatalogChoices = new HashMap();
		productCatalogChoices.put(BOOKS,prodCatalogBooks);
		productCatalogChoices.put(CLOTHES,prodCatalogClothes);
	}
	
	public String[][] getProductCatalogChoices(String catalogType) {
		return (String[][])productCatalogChoices.get(catalogType);
	}
	...
	public static String[][] getCatalogTypes() {
		return catalogTypes;
	}
	...
	private static String[][] shipAddresses = 
 		{{"1607 Granville Ave",
 		 ...
 		 "IA",
 		 "52556"}};
 	public String[][] getShipAddresses() {
    ...
    public String[][] getFinalOrderData() {
    ...
    ////////////Fake data for quantity window
    private String numAvailable = "50";
