...
public class FinalOrderWindow extends JWindow implements ParentWindow {
	 ...
	 * The GUI Skeleton loads data by reading fake data from the DefaultData
	 ...
	 * then read during execution of updateModel. 
	 */
	private void updateModel() {
        ...
        if(USE_DEFAULT_DATA) {
			...
			String[][] defaultData = data.getFinalOrderData();
